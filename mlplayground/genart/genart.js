...
function getColorAt(model, x, y) {
  ...
  r = Math.floor(out.w[0]*10)/10.0*255.0;
  g = Math.floor(out.w[1]*10)/10.0*255.0;
  b = Math.floor(out.w[2]*10)/10.0*255.0;
  //return color(r*0.27+g*0.71,g*0.71+b*0.27,b*0.27+r*0.71);
  return color(r,g,b);
}
...
function setup() {
  ...
  img.save('neural network art '+Date()+'.png','png');
